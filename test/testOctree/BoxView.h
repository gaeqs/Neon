...
class BoxView : public neon::Component
{
    ...
    void generateModel()
    {
        ...
        info.drawables.push_back(std::make_unique<neon::Mesh>(getApplication(), "box", _material, false, false));
  ...
  public:
    BoxView(std::shared_ptr<neon::Material> material, const rush::AABB<3, float>& box, float index) :
