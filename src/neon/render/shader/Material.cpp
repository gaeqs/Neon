...
namespace neon
{
    ...
    Material::Material(Application* application, const std::string& name, const MaterialCreateInfo& createInfo) :
    ...
    void Material::pushConstant(const std::string& name, const void* data, uint32_t size)
    {
    ...
    std::unique_ptr<Material> Material::create(Application* application, const std::string& name,
                                               ...
                                               const std::vector<std::shared_ptr<SampledTexture>>& textures)
    {
        ...
        auto uniformDescriptor = std::make_shared<ShaderUniformDescriptor>(application, name, bindings);
