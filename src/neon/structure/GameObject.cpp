...
namespace neon
{
    ...
    const std::unordered_set<IdentifiableWrapper<GameObject>>& GameObject::getChildren() const
    {
        return _children;
    }

    const std::unordered_set<IdentifiableWrapper<Component>>& GameObject::getComponents() const
    {
        return _components;
    }
