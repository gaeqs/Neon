...
namespace neon
{
    ComponentImplementedEvents::ComponentImplementedEvents(
        ...
        std::type_index onLateUpdateFunction, std::type_index onPreDrawFunction, std::type_index onLatePreDrawFunction,
        std::type_index onKeyFunction, std::type_index onCharFunction, std::type_index onMouseButtonFunction,
        ...
        onLatePreDraw(onLatePreDrawFunction != typeid(&Component::onLatePreDraw)),
