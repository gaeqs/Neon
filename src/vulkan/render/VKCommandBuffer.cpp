...
namespace neon::vulkan
{
        ...
        _external(false)
    {
        ...
        _queueHolder = _vkApplication->getDevice()->getQueueProvider()->fetchQueue(pool.getQueueFamilyIndex());
    ...
    VKCommandBuffer::VKCommandBuffer(Application* application, VkCommandBuffer commandBuffer, VkQueue queue) :
        _vkApplication(dynamic_cast<AbstractVKApplication*>(application->getImplementation())),
    ...
    bool VKCommandBuffer::begin(bool onlyOneSubmit)
    {
        ...
        beginInfo.flags = onlyOneSubmit ? VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT : 0;
    ...
    void VKCommandBuffer::reset(bool releaseResources)
    {
        ...
        VkCommandBufferResetFlags bit = releaseResources ? VK_COMMAND_BUFFER_RESET_RELEASE_RESOURCES_BIT : 0;
    ...
    void VKCommandBuffer::printInvalidState(VKCommandBufferStatus expected) const
    {
